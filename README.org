...
- [[Kitty theme][https://github.com/laniusone/kyotonight.vim/blob/master/extras/kitty/kyotonight.conf]]
...
- Kvantum, i3, rofi and dunst themes coming soon

** Todos

- [x] Make code a little cleaner
- [ ] Clean lightline and airline code as well
...
- [ ] Make sure coc looks good
- [ ] Look into maybe different cursor color, and visual highlight
